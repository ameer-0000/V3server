...
mandatory_subscription_channel = 'https://t.me/jokeramer1'
BOT_TOKEN = '7117249870:AAEMBp3GjHZgaJH-mO1cjz1KYrb5gjmcSVg' # token 
ADMIN_ID = '6588717844'  # id
...
bot_creator = "@joker1444"   # هنا هتحط معرفك علشان يظهر للناس في بدايه البوت 
...
def start(message):
    ...
    # معرف الأدمن (قم بتغيير هذا إلى معرفك الشخصي)
    ADMIN_ID = '6588717844'  # ضع معرف الإدمن هنا

    if message.from_user.username in banned_users:
        bot.send_message(message.chat.id, "تم حظرك من البوت. تواصل مع المطور @M3_mo2")
        return

    # استثناء الأدمن من التحقق من الاشتراك
    if str(message.from_user.id) != ADMIN_ID:
        # تحقق من الاشتراك إذا لم يكن المستخدم هو الأدمن
